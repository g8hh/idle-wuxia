...
var cnItems = {
    ...
    "Press space bar to start a drag.\n  When dragging you can use the arrow keys to move the item around and escape to cancel.\n  Some screen readers may require you to be in focus mode or to use your pass through key": "按空格键开始拖动。拖动时，可以使用方向键移动元素，也可以按 Escape 键取消。\n某些屏幕阅读器可能需要您处于对焦模式或使用直通键",
    "Adventures": "冒险",
    "Battles": "战斗",
    "Bestiary": "兽谱",
    "Craft Queue": "制作队列",
...
var cnRegReplace = new Map([
    ...
    [/^Body, lvl (.+), Cripple$/, '身体，$1 级，残废'],
    [/^Meridians, lvl (.+), Cripple$/, '经脉，$1 级，残废'],
    [/^Spirit, lvl (.+), Cripple$/, '灵识，$1 级，残废'],
    [/^Spirit, lvl (.+), Mortal$/, '灵识，$1 级，凡人'],
    [/^Body, lvl (.+), Mortal$/, '身体，$1 级，凡人'],
    [/^Meridians, lvl (.+), Mortal$/, '经脉，$1 级，凡人'],
    [/^Meridians, lvl (.+), Cultivator$/, '经脉，$1 级，农夫'],
    [/^Body, lvl (.+), Cultivator$/, '身体，$1 级，农夫'],
    [/^Spirit, lvl (.+), Cultivator$/, '灵识，$1 级，农夫'],
	[/^([\d\.]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+) OOMs\/sec$/, '$1 OOMs\/秒'],
	[/^([\d\.]+) OOMs\/sec$/, '$1 OOMs\/秒'],
